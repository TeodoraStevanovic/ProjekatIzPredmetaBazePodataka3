 ...
 * @author Korisnik
 */
public class FrmDodajVozilo extends javax.swing.JDialog {

    /**
     * Creates new form FrmDodajVozilo
     */
    public FrmDodajVozilo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        try {
//            prepareView();
    ...
    private void btnIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzmeniActionPerformed
        try {
            ...
            .validateNotNullOrEmpty(txtbrsasije.getText(), "broj sasije je obavezno polje")
            .validateNotNullOrEmpty(txtmodel.getText(), "naziv modela je obavezno polje")
            
            .validateNotNullOrEmpty(txtmarka.getText(), "naziv marke je obavezno polje")
               .throwIfInvalide();
            Vozilo v= new Vozilo();
            ...
            Controller.getInstance().addVozilo(v);
            JOptionPane.showMessageDialog(this, "Sistem je zapamtio vozilo.", "Uspešno čuvanje vozilo", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Sistem ne može da zapamti vozilo", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDodajVozilo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDodajVozilo dialog = new FrmDodajVozilo(new javax.swing.JFrame(), true);
