 ...
 * @author Korisnik
 */
public class FrmDodajVozaca extends javax.swing.JDialog {

    /**
     * Creates new form FrmDodajVozaca
     */
    public FrmDodajVozaca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btnIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzmeniActionPerformed
        try {
            ...
            .validateNotNullOrEmpty(txtblk.getText(), "broj licne karte je obavezno polje")
            .validateNotNullOrEmpty(ttxprezime.getText(), "prezime je obavezno polje")
            ...
            Controller.getInstance().addVozac(v);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDodajVozaca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDodajVozaca dialog = new FrmDodajVozaca(new javax.swing.JFrame(), true);
