 ...
 * @author Korisnik
 */
public class FrmDodajStavkeNaloga extends javax.swing.JDialog {

    /**
     * Creates new form FrmDodajStavkeNaloga
     */
    public FrmDodajStavkeNaloga(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         try {
            prepareView();
                ...
                .addGroup(panelProduct1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelProduct1Layout.createSequentialGroup()
                        ...
                        .addGroup(panelProduct1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cmbRoba, 0, 624, Short.MAX_VALUE)
                    ...
                    .addGroup(panelProduct1Layout.createSequentialGroup()
                        ...
                        .addGap(68, 68, 68)
                        .addGroup(panelProduct1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbNalog, 0, 572, Short.MAX_VALUE)
        ...
        panelProduct1Layout.setVerticalGroup(
            ...
            .addGroup(panelProduct1Layout.createSequentialGroup()
                ...
                .addGroup(panelProduct1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(lblID1)
                    .addComponent(txtrbstavke, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
       ...
       //     System.err.println(rb);
          ...
          sn.setPorez(Integer.parseInt(txtporez.getText().trim()));
           sn.setRoba((Roba) cmbRoba.getSelectedItem());
            ...
            Controller.getInstance().addStavkaNaloga(sn);
            JOptionPane.showMessageDialog(this, "Sistem je zapamtio stavku naloga.", "Uspešno čuvanje stavke naloga", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Sistem ne može da zapamti stavku naloga", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDodajStavkeNaloga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDodajStavkeNaloga dialog = new FrmDodajStavkeNaloga(new javax.swing.JFrame(), true);
