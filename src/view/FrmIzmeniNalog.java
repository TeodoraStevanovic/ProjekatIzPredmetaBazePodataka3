 ...
 * @author Korisnik
 */
public class FrmIzmeniNalog extends javax.swing.JDialog {

    /**
     * Creates new form FrmIzmeniNalog
     */
    public FrmIzmeniNalog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         try {
            prepareView();
            ...
            .addGroup(panelProduct1Layout.createSequentialGroup()
                ...
                .addGroup(panelProduct1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelProduct1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtukupno, javax.swing.GroupLayout.PREFERRED_SIZE, 404, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(440, 440, 440))
                    .addGroup(panelProduct1Layout.createSequentialGroup()
    ...
    private void btnIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzmeniActionPerformed
        try {
           ...
           nalog.setDatum(jsd);
            ...
            nalog.setUkupnaVrednost(Double.parseDouble(txtukupno.getText().trim()));
            //ukupnu vrednost ne postavljamo

            Controller.getInstance().editNalog(nalog);
            JOptionPane.showMessageDialog(this, "Sistem je izmenio nalog.", "Uspešno čuvanje nalog", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Sistem ne može da izmeni nalog", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmIzmeniNalog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmIzmeniNalog dialog = new FrmIzmeniNalog(new javax.swing.JFrame(), true);
    ...
    void setNalog(Nalog r) {
        brnaloga.setText(r.getBrojNaloga());
        jDateChooser1.setDateFormatString("yyyy-MM-dd");
        jDateChooser1.setDate(r.getDatum());
        txtnapomena.setText(r.getNapomena());
        
        
        cmbKorisnik.setSelectedItem(r.getKorisnik());
        cmbMagacin.setSelectedItem(r.getMagacin());
        cmbMaloprodaja.setSelectedItem(r.getMaloprodaja());
        cmbVozac.setSelectedItem(r.getVozac());
        cmbVozilo.setSelectedItem(r.getVozilo());
        txtukupno.setText(String.valueOf(r.getUkupnaVrednost()));
